...
const PresaveModal: React.FC<PresaveModalProps> = ({ release, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex flex-col bg-slate-900 font-sans">
            {/* Dynamic Background Image - Blurry & Full Screen */}
            <div 
            ...
            {/* Main Full Screen Container - No width restrictions on the wrapper to ensure immersion */}
            <div className="relative z-10 w-full h-full overflow-y-auto overflow-x-hidden animate-fade-in">
                ...
                <div className="min-h-full w-full flex flex-col items-center justify-center p-6 md:p-12">
                    ...
                    {/* Content constrained only for readability, but visually floating in full space */}
                    <div className="w-full max-w-[500px] flex flex-col items-center">
                        ...
                        <div className="pt-8 mt-8 border-t border-white/10 w-full flex flex-col items-center gap-6">
                            ...
                            <button 
                                onClick={onClose}
                                className="group relative px-8 py-3 overflow-hidden rounded-full bg-transparent border border-white/20 text-white transition-all duration-300 hover:bg-white/10 hover:border-white/40 hover:scale-105"
                            >
                                <div className="absolute inset-0 bg-white/5 blur-md opacity-0 group-hover:opacity-100 transition-opacity"></div>
                                <div className="relative flex items-center gap-3">
                                    <span className="font-semibold text-sm tracking-widest uppercase">Continuar al sitio web</span>
                                    <svg 
