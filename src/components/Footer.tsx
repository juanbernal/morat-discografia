            ...
            <div className="max-w-7xl mx-auto px-4 md:px-8 pt-16 pb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
                    ...
                    <div className="space-y-5">
                        <div className="flex items-center gap-3">
                            <div className="w-10 h-10 rounded-xl bg-blue-600/20 border border-blue-500/20 flex items-center justify-center">
                                <Disc3 size={20} className="text-blue-400" />
                            </div>
                            <div>
                    ...
                    <div>
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            >
                                <div className="flex items-center gap-3">
                                    <YoutubeMusicIcon className="w-4 h-4 text-red-400" />
                ...
                <div className="border-t border-white/5 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
                    ...
                    <p className="flex items-center gap-1.5 text-white/20 text-[9px]">
                        Hecho con <Heart size={10} className="text-red-500/60 fill-current" /> en México · Música Independiente
                    </p>
                </div>
            </div>
        </footer>
